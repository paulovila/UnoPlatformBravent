...
namespace UnoWebApiSwagger.WebApiClient
{
    ...
    public partial interface IRateWebClient
    {
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<Rates> GetAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    
    }
    
    [System.CodeDom.Compiler.GeneratedCode("NSwag", "13.3.0.0 (NJsonSchema v10.1.11.0 (Newtonsoft.Json v12.0.0.0))")]
    public partial class RateWebClient : TokenBaseClient, IRateWebClient
    {
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;
    
        public RateWebClient(ITokenClientConfig configuration) : base(configuration)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="SwaggerException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Rates> GetAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/Rate/Get");
    ...
    public partial class Rates : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        public static Rates FromJson(string data)
        {
            return Newtonsoft.Json.JsonConvert.DeserializeObject<Rates>(data);
        }
    ...
    public partial class Currency : System.ComponentModel.INotifyPropertyChanged
    {
        ...
        [Newtonsoft.Json.JsonProperty("SpotRate", Required = Newtonsoft.Json.Required.Always)]
        ...
        [Newtonsoft.Json.JsonProperty("SpotWeek", Required = Newtonsoft.Json.Required.Always)]
        public decimal SpotWeek
        {
            get { return _spotWeek; }
            set 
            {
                if (_spotWeek != value)
                {
        ...
        [Newtonsoft.Json.JsonProperty("SpotMonth", Required = Newtonsoft.Json.Required.Always)]
        public decimal SpotMonth
        {
            get { return _spotMonth; }
            set 
            {
                if (_spotMonth != value)
                {
        ...
        [Newtonsoft.Json.JsonProperty("SpotMonth6", Required = Newtonsoft.Json.Required.Always)]
        public decimal SpotMonth6
        {
            get { return _spotMonth6; }
            set 
            {
                if (_spotMonth6 != value)
                {
                    _spotMonth6 = value; 
                    RaisePropertyChanged();
                }
